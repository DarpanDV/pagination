      ...
      {product.length != 0 ?
        (<>
          ...
          <div style={{ display: "flex",justifyContent:"center" }}>
            <span style={{cursor:"pointer",padding:"5px"}} onClick={()=>handleLeftPointer()}>⬅️</span>
            {
              page.map((pg) => {
                return (
            ...
            <span style={{cursor:"pointer",padding:"5px"}} onClick={()=>handleRightPointer()}>➡️</span>
          </div>
        </>) : (<h1>Loading....</h1>)}
    </>
  )
